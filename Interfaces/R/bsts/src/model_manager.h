...
namespace bsts {
 ...
 private:
  ...
  // for inference, and to provide any additional data that the models need for
  // tasks other than statistical inference.  In this way a ModelManager is much
  // like a factory, but the ModelManager is expected to persist and own global
  // state, whereas a factory traditionally does not.
  //
