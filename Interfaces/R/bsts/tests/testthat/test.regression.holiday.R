...
TestRegressionHolidayModel <- function() {
  ...
  expect_that(ncol(model$MemorialDay), equals(length(memorial.day.effects)))


}

TestHierarchicalRegressionHolidayModel <- function() {
