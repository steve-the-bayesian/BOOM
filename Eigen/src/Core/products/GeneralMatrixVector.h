...
//  const Index PeelAlignedMask = ResPacketSize*peels-1;
  ...
  const Index offset1 = (static_cast<bool>(static_cast<int>(FirstAligned)) && alignmentStep==1)?3:1;
  const Index offset3 = (static_cast<bool>(static_cast<int>(FirstAligned)) && alignmentStep==1)?1:3;
