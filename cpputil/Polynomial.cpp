...
*/
 ...
 L180:
    ...
    i__1 = global_1.n;
    for (i__ = 2; i__ <= i__1; ++i__) {
      global_1.k[i__ - 1] = (double) (global_1.nn - i__) * global_1.p[i__ - 1]
          / (double) global_1.n;
      /* L190: */
    }
    ...
    for (jj = 1; jj <= 5; ++jj) {
      ...
      global_1.k[0] = global_1.p[0];
      zerok = (d__1 = global_1.k[global_1.n - 1], fabs(d__1)) <= fabs(bb) *
          global_1.eta * 10.;
      goto L230;
  ...
  /* Subroutine */ int fxshfr_(int *l2, int *nz)
  {
    ...
    static bool vpass;
    extern /* Subroutine */ int calcsc_(int *), realit_(double *,
 ...
 L10:
    ...
    quadsd_(&global_1.nn, &global_1.u, &global_1.v, global_1.p, global_1.qp, &
            global_1.a, &global_1.b);
    mp = (d__1 = global_1.a - global_1.szr * global_1.b, fabs(d__1)) + (d__2 =
                                                                        global_1.szi * global_1.b, fabs(d__2));
    ...
    ee = (global_1.mre * (double)5. + global_1.are * (double)4.) * ee - (
        global_1.mre * (double)5. + global_1.are * (double)2.) * ((r__2 = (
            double) global_1.a + t, fabs(r__2)) + (r__1 = (double) global_1.b,
                                                   fabs(r__1)) * zm) + global_1.are * (double)2. * fabs(t);
 ...
 L10:
    ...
    /* P */
    ms = fabs(s);
    ee = global_1.mre / (global_1.are + global_1.mre) * (r__1 = (double)
                                                         global_1.qp[0], fabs(r__1));
    i__1 = global_1.nn;
    for (i__ = 2; i__ <= i__1; ++i__) {
 ...
 L50:
    ...
    if (fabs(kv) <= (d__1 = global_1.k[global_1.n - 1], fabs(d__1)) * (double)
        10. * global_1.eta) {
      goto L80;
    }
