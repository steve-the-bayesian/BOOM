...
static void rdqagie(const integr_fn &f, void *ex,
                    double *, int *, double * , double *, int *,
                    double *, double *, int *,
                    int *, double *, double *, double *, double *,
                    int *, int *);

static void rdqk15i(const integr_fn &f, void *ex,
                    double *, int *, double * , double *,
                    double *, double *, double *, double *);

static void rdqagse(const integr_fn &f, void *ex, double *, double *,
                    double *, double *, int *, double *, double *,
                    int *, int *, double *, double *, double *,
                    double *, int *, int *);

static void rdqk21(const integr_fn &f, void *ex,
...
static
void rdqagie(const integr_fn &f,
             void *ex,
             double *bound,
             int *inf,
             double * epsabs,
...
void Rdqags(const integr_fn &f, // integrand
            void *ex,    // NULL pointer
...
static
void rdqagse(const integr_fn &f,
             void *ex,
             double *a,
             double *b,
             double * epsabs,
...
static void rdqk15i(const integr_fn &f,
                    void *ex,
                    double *boun,
                    int *inf,
                    double *a,
...
static void  rdqk21(const integr_fn &f,
                    void *ex,
                    double *a,
                    double *b,
                    double *result,
