#ifndef BOOM_MODELS_GP_GP_MEAN_FUNCTION_POSTERIOR_SAMPLER_HPP_
#define BOOM_MODELS_GP_GP_MEAN_FUNCTION_POSTERIOR_SAMPLER_HPP_
...
namespace BOOM {
  ...
  class GpMeanFunctionSampler : public GP::ParameterSampler {
   public:
    ...
    //     function.
    GpMeanFunctionSampler(GpMeanFunction *mean_function,
   ...
   private:
    GpMeanFunction *mean_function_;
    GaussianProcessRegressionModel *model_;
  };

}  // namespace BOOM

#endif  //  BOOM_MODELS_GP_GP_MEAN_FUNCTION_POSTERIOR_SAMPLER_HPP_
