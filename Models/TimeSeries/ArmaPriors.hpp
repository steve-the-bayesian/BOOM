...
namespace BOOM {
        ...
        public PriorPolicy
  {
   public:
    ...
    UniformMaPrior *clone() const override {
      return new UniformMaPrior(*this);
    }
  ...
  class UniformArPrior
   ...
   public:
    ...
    UniformArPrior *clone() const override {
      return new UniformArPrior(*this);
    }
    double logp(const Vector &x) const override;
    Vector sim(RNG &rng = GlobalRng::rng) const override;
   private:
