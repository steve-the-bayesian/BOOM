...
namespace BOOM {
  ...
  void PoissonDataImputer::impute(RNG &rng, int response, double exposure,
                                  double log_lambda,
                                  double *internal_neglog_final_event_time,
                                  double *internal_mu, double *internal_weight,
    ...
    double final_interarrival_time =
        exposure - time_of_final_internal_event + rexp_mt(rng, exp(log_lambda));
