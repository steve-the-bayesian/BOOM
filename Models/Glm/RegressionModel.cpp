...
namespace BOOM{
  ...
  void NeRegSuf::add_mixture_data(double y,
  ...
  RDP::RegressionDataPolicy(const Ptr<RegSuf> & s)
    : DPBase(s)
  {}
  ...
  RM::RegressionModel(const Ptr<GlmCoefs> &beta,
  ...
  double RM::Loglike(const Vector &beta_sigsq,
