...
namespace BOOM{
  ...
  MvnGivenX::MvnGivenX(const Ptr<VectorParams> & Mu, const Ptr<UnivParams> &nobs, double diag)
    : ParamPolicy(Mu, nobs),
      diagonal_weight_(diag),
      Lambda_(Mu->dim(), 0),
  ...
  MvnGivenX::MvnGivenX(const Ptr<VectorParams> & Mu,
                       const Ptr<UnivParams> &nobs,
                       const Vector & Lambda,
                       double diag)
    : ParamPolicy(Mu, nobs),
      diagonal_weight_(diag),
